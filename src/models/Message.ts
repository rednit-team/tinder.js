...
export default class Message {
  ...
  constructor(message: { _id: any; match_id: any; sent_date: string | number | Date; message: any; to: any; from: any; timestamp: string; created_date: string | number | Date; is_liked: any }) {
    this.id = message._id
